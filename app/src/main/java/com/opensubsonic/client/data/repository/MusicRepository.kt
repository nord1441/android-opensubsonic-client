...
class MusicRepository @Inject constructor(
    ...
    suspend fun markSongAsNotDownloaded(songId: String) {
        musicDao.markAsNotDownloaded(songId)
    }

    suspend fun clearAllDownloadStatus() {
        musicDao.clearAllDownloadStatus()
    }
    ...
    suspend fun getAllSongsOnce(): List<Song> = musicDao.getAllSongsOnce()
